...
const Product = (props) => {
    ...
    return (
        ...
        <div className="align-content-center pe-5 pt-2"><img src={picture} alt="product" height="350" width="420" /></div>
        ...
        <Link to={`/inventory/${_id}`} data={data}><Button variant="primary mb-3 mt-3  ">Update</Button></Link>
